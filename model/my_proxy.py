...
def verify2(ip, port, type):
    ...
    res = requests.get(url="http://icanhazip.com/", timeout=cfg.TIMEOUT, proxies={type: thisProxy})
...
if __name__ == '__main__':
    # getProxy('https://raw.githubusercontent.com/fate0/proxylist/master/proxy.list')  # 获取代理
